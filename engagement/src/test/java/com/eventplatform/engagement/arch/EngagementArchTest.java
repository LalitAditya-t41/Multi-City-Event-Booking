...
class EngagementArchTest {
  ...
  static final ArchRule should_not_call_eventbrite_directly =
      noClasses()
          ...
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage("..com.eventbrite..");
  ...
  static final ArchRule should_not_call_openai_sdk_directly =
      noClasses()
          ...
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage("..com.theokanning.openai..");
  ...
  static final ArchRule service_and_controller_should_not_construct_review_response_directly =
      noClasses()
          .that()
          .resideInAnyPackage("..engagement.service..", "..engagement.api.controller..")
          .should()
          .callConstructor(ReviewResponse.class);
}
