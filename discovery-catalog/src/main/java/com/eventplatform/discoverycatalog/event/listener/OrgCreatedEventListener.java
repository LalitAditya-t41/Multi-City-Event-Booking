...
public class OrgCreatedEventListener {
    ...
    public OrgCreatedEventListener(
        ...
        @Value("${eventbrite.webhook.endpoint-url:http://localhost:8080/admin/v1/webhooks/eventbrite}") String endpointUrl
    ) {
    ...
    public void onOrgCreated(OrgCreatedEvent event) {
        ...
        EbWebhookRegistrationResult result = ebWebhookService.registerWebhook(
