...
@Import({GlobalExceptionHandler.class, SecurityConfig.class, AdminSlotCancelControllerTest.MockBeans.class})
class AdminSlotCancelControllerTest {
    ...
    void should_delegate_slot_cancel_to_scheduling_module_when_admin_requests_cancel() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/admin/slots/77/cancel").queryParam("orgId", "88"))
