...
public class Coupon extends BaseEntity {
  ...
  public String getEbDiscountId() {
    return ebDiscountId;
  }

  public EbSyncStatus getEbSyncStatus() {
    return ebSyncStatus;
  }

  public Integer getEbQuantitySoldAtLastSync() {
    return ebQuantitySoldAtLastSync;
  }

  public Instant getLastEbSyncAt() {
    return lastEbSyncAt;
  }

  public boolean canEbDelete() {
    return ebDiscountId != null
        && (ebQuantitySoldAtLastSync == null || ebQuantitySoldAtLastSync == 0);
  }
}
