...
public class DiscountReconciliationLog extends BaseEntity {
  ...
  public DiscountReconciliationLog(
      Long orgId,
  ...
  public int getDiscountsChecked() {
    return discountsChecked;
  }

  public int getDriftsFound() {
    return driftsFound;
  }

  public int getOrphansFound() {
    return orphansFound;
  }

  public int getExternallyDeletedFound() {
    return externallyDeletedFound;
  }

  public String getActionsTakenSummary() {
    return actionsTakenSummary;
  }
