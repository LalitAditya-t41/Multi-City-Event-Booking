...
class BookingInventoryArchTest {
  ...
  /**
   * Hard Rule #1 — booking-inventory must not reach into scheduling internals directly. All access
   * to scheduling data goes through shared reader interfaces only.
   */
  @ArchTest
  static final ArchRule should_not_depend_on_scheduling_domain_service_or_repository =
      noClasses()
          .that()
          .resideInAPackage("..bookinginventory..")
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage(
  ...
  /**
   * Interface migration rule — confirms SchedulingSlotClient (deleted HTTP client) has no remaining
   * references. booking-inventory must use SlotSummaryReader / SlotPricingReader from shared, not
   * direct HTTP.
   */
  @ArchTest
  ...
  static final ArchRule should_not_import_identity_entity_or_repository_in_booking_inventory =
      noClasses()
          ...
          .dependOnClassesThat()
          .resideInAnyPackage(
              "..com.eventplatform.identity.domain..", "..com.eventplatform.identity.repository..");
  ...
  static final ArchRule should_not_call_eventbrite_http_directly_from_booking_inventory_service =
      noClasses()
          .that()
          .resideInAPackage("..bookinginventory.service..")
          .should()
          .dependOnClassesThat()
  ...
  static final ArchRule should_not_declare_ControllerAdvice_in_booking_inventory =
      classes()
          ...
          .resideInAPackage("..bookinginventory..")
          .should()
          .notBeAnnotatedWith(org.springframework.web.bind.annotation.ControllerAdvice.class)
          .andShould()
          .notBeAnnotatedWith(org.springframework.web.bind.annotation.RestControllerAdvice.class);

  @ArchTest
  static final ArchRule should_enforce_mapper_layer_for_all_domain_to_dto_conversions =
      noClasses()
          .that()
          .resideInAPackage("..bookinginventory.api.controller..")
          .should()
          .dependOnClassesThat()
  ...
  void should_only_save_audit_log_no_update_or_delete() {
    assertThat(
            Arrays.stream(
                    com.eventplatform.bookinginventory.repository.SeatLockAuditLogRepository.class
                        .getDeclaredMethods())
