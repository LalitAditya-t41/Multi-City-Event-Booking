...
@Entity
@Table(name = "seats", uniqueConstraints = @UniqueConstraint(name = "uq_seat_position", columnNames = {"show_slot_id", "seat_number"}))
public class Seat extends BaseEntity {
    ...
    public Seat(Long showSlotId, Long pricingTierId, String ebTicketClassId, String seatNumber, String rowLabel, String section) {
    ...
    public void release(LockReleaseReason reason) {
        if (this.lockState == SeatLockState.CONFIRMED) {
            throw new BusinessRuleException("Confirmed seat cannot be released", "SEAT_ALREADY_CONFIRMED");
        }
        this.lockState = SeatLockState.AVAILABLE;
        this.lockedByUserId = null;
        this.lockedUntil = null;
