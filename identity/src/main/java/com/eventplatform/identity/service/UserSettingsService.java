...
public class UserSettingsService {
    ...
    public UserSettingsResponse getMySettings(Long userId) {
        UserSettings settings = userSettingsRepository.findWithPreferencesByUserId(userId)
    ...
    public UserSettingsResponse upsertMySettings(Long userId, UserSettingsUpsertRequest request) {
        ...
        PreferenceOption cityOption = preferenceOptionRepository
            .findByIdAndTypeAndActiveTrue(request.preferredCityOptionId(), PreferenceOptionType.CITY)
        ...
        List<PreferenceOption> genreOptions = preferenceOptionRepository
            .findByIdInAndTypeAndActiveTrue(genreIds, PreferenceOptionType.GENRE);
