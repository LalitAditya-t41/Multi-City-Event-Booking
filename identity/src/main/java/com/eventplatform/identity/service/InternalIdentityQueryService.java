...
public class InternalIdentityQueryService {
    ...
    public InternalIdentityQueryService(UserRepository userRepository, UserSettingsRepository userSettingsRepository) {
    ...
    public DisplayNameResponse getDisplayName(Long userId) {
        ...
        String displayName = fullName.filter(name -> !name.isBlank())
