...
public class AuthService {
    ...
    public AuthTokensResponse login(LoginRequest request) {
        User user = userRepository.findByEmailIgnoreCase(normalizeEmail(request.email()))
            .orElseThrow(() -> new IdentityException("Invalid credentials", "INVALID_CREDENTIALS", HttpStatus.UNAUTHORIZED));
    ...
    public AccessTokenResponse refreshToken(String refreshTokenRaw) {
        RefreshToken refreshToken = refreshTokenRepository.findByTokenHash(hashToken(refreshTokenRaw))
            .orElseThrow(() -> new IdentityException("Refresh token invalid", "REFRESH_TOKEN_INVALID", HttpStatus.UNAUTHORIZED));
    ...
    public MessageResponse logout(String refreshTokenRaw) {
        Optional<RefreshToken> refreshTokenOpt = refreshTokenRepository.findByTokenHash(hashToken(refreshTokenRaw));
    ...
    public MessageResponse confirmPasswordReset(PasswordResetConfirmRequest request) {
        ...
        PasswordResetToken token = passwordResetTokenRepository.findByTokenHash(hashToken(request.token()))
            .orElseThrow(() -> new ValidationException("Reset token invalid", "RESET_TOKEN_INVALID"));
        ...
        PasswordResetToken latestToken = passwordResetTokenRepository.findTopByUserIdOrderByCreatedAtDesc(token.getUser().getId())
            .orElseThrow(() -> new ValidationException("Reset token invalid", "RESET_TOKEN_INVALID"));
