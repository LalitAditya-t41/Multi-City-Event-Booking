...
class UserSettingsServiceTest {
    ...
    void should_validate_active_preference_options_before_upsert() {
        ...
        when(preferenceOptionRepository.findByIdInAndTypeAndActiveTrue(anyCollection(), org.mockito.ArgumentMatchers.eq(PreferenceOptionType.GENRE)))
            .thenReturn(List.of(new PreferenceOption(PreferenceOptionType.GENRE, "Rock", true, 1)));

        UserSettingsUpsertRequest request = new UserSettingsUpsertRequest(
            "Full Name",
            "9999999999",
            null,
            "Address",
