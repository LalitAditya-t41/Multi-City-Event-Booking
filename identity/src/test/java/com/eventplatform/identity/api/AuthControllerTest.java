...
class AuthControllerTest {
    ...
    void should_return_409_on_register_when_email_exists() throws Exception {
        when(authService.register(any(RegisterRequest.class)))
            .thenThrow(new com.eventplatform.identity.exception.IdentityException(
    ...
    void should_return_200_on_logout() throws Exception {
        when(authService.logout("refresh-ok")).thenReturn(new MessageResponse("Logged out successfully"));
