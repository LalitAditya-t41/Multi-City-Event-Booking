...
public class EbProperties {
    ...
    /**
     * Static API key used as fallback when OAuth per-org tokens are not yet stored.
     * In production this should be injected via the EVENTBRITE_API_KEY environment variable.
     * For local development against the mock server the default value {@code mock-token} is used.
     */
