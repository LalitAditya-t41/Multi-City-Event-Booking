...
/**
 * Eventbrite v3 event response payload. The mock / real API returns nested objects for {@code
 * name}, {@code start}, and {@code end}.
 */
...
public record EbEventDto(
    ...
    /**
     * Resolved from the nested {@code name.html} or {@code name.text} field by the {@link
     * EbEventDto.NameField} helper during Jackson deserialization.
     */
  ...
  public Instant startTime() {
    return start != null && start.utc() != null ? Instant.parse(start.utc()) : null;
  }

  /** Returns the UTC end time as {@link Instant}. */
  public Instant endTime() {
    return end != null && end.utc() != null ? Instant.parse(end.utc()) : null;
  }
  ...
  @JsonIgnoreProperties(ignoreUnknown = true)
  public record NameField(@JsonProperty("html") String html, @JsonProperty("text") String text) {}

  @JsonIgnoreProperties(ignoreUnknown = true)
  public record DescriptionField(
      @JsonProperty("html") String html, @JsonProperty("text") String text) {}
