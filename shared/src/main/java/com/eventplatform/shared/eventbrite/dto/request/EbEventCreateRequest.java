...
/**
 * Eventbrite v3 event creation payload (the inner object). The facade wraps this in {@code
 * {"event": <this>}} before POSTing.
 *
 * <p>Serialises to:
 *
 * <pre>
...
public record EbEventCreateRequest(
  ...
  /**
   * Convenience factory — converts plain strings and {@link java.time.ZonedDateTime} values into
   * the nested objects Eventbrite expects.
   */
