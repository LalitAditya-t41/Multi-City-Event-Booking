...
/**
 * Eventbrite v3 event update payload (the inner object). The facade wraps this in {@code {"event":
 * <this>}} before POSTing.
 */
public record EbEventUpdateRequest(
  ...
  public static EbEventUpdateRequest of(
    ...
    return new EbEventUpdateRequest(
        ...
        startTime != null
            ? new EbTimeDto(startTime.toInstant().toString(), startTime.getZone().getId())
            : null,
        endTime != null
