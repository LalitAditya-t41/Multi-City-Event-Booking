...
/**
 * Published by booking-inventory when cart lock is confirmed (HARD_LOCKED transition). Consumed by
 * payments-ticketing to create a Stripe PaymentIntent.
 *
 * <p>Rule 4 compliance: contains only primitives, IDs, and Strings -- no @Entity objects.
